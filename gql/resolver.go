...
func NewResolver(cfg *config.Config, orderRepository *repository.OrderRepository, userRepository *repository.UserRepository) Resolver {
	return Resolver{cfg, orderRepository, userRepository}
}
