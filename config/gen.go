...
func params(values ...interface{}) valueHandlerParams {
	return valueHandlerParams{values[0].(Field), values[1].(string)}
}

var configTemplate = template.Must(template.New("config").Funcs(template.FuncMap{"params": params}).Parse(`// Code generated by gen; DO NOT EDIT.
package {{.Package}}
